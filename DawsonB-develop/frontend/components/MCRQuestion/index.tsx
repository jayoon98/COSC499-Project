...
export default function MCRQuestion({ props }) {
  ...
  function mapQuestions() {
        ...
        questions.push(
          <div key={`q-${idx}-${i}`}>
            <div className="question-spacing-edit">
              <input className="question-spacing" type="radio" disabled name={`${idx}`} value={`${idx}-${i}`} data-testid="mcrQuestion" />
        ...
        questions.push(
          <div key={`q-${idx}-${i}`}>
            <div className="question-spacing">
              <input className="question-spacing" type="radio" name={`${idx}`} value={`${idx}-${i}`} data-testid="mcrQuestion" onChange={() => validate()} ref={qRefs[i]} />
    ...
    if (admin) {
      ...
      if (extra) {
        questions.push(
          <div className="question-sa-edit" style={{ marginLeft: 0 }} key={`q-${idx}-extra`}>
            <input className="question-spacing" type="radio" disabled name={`${idx}`} value={`${idx}-extra`} data-testid="mcrQuestion" />
      ...
      questions.push(
        <div key={`q-${idx}-extra`}>
          <p>
            <input className="question-spacing" type="radio" name={`${idx}`} value={`${idx}-extra`} data-testid="mcrQuestion" onChange={() => validate()} ref={extraRefRadio} />
            {extra}
          </p>
          <input
            style={
